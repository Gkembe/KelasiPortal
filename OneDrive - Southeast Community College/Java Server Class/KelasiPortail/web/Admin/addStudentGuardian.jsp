                ...
                <div class="section">
                    ...
                    <form class="form" action="${pageContext.request.contextPath}/Private" method="post">
                        ...
                        <div class="actions">
                            ...
                            <a class="btn" href="${pageContext.request.contextPath}/Private?action=studentProfile&registrationNumber=${student.registrationNumber}&studentID=${student.studentID}&userID=${student.userID}">Cancel</a>
                        </div>
                    </form>
