<%-- 
    Document   : signup
    Created on : Nov 27, 2025, 6:49:34 PM
    Author     : kembe
--%>
    ...
    <body>
        ...
        <main>
            <section class="auth-card" aria-labelledby="signup-title">
                <h1 id="signup-title">Create School Account</h1>
                <p class="auth-subtitle">Register your school to start enrolling students.</p>
                <p>${message}</p>
                ...
                <form class="auth-form" id="signupForm" action="Public" method="post" enctype="multipart/form-data">

                    <input type="hidden" name="action" value="signup">
                    <div class="input-group">
                        <label for="schoolName">School Name</label>
                        <input type="text" id="schoolName" name="schoolname" placeholder="e.g., Lincoln High School" />
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="schoolcity" name="schoolcity" placeholder="e.g., Lincoln" />
                    </div>
                    <div class="input-group">
                        <label for="schooladdress">School Address</label>
                        <input type="text" id="schooladdress" name="schooladdress" placeholder="e.g., 118 D street"/>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="schoolemail" name="schoolemail" placeholder="admin@school.com"  />
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="username" name="username" placeholder="Andree"  />
                    </div>


                    <div class="input-group">
                        <label for="adminemail">Email ADMIN</label>
                        <input type="email" id="adminemail" name="adminemail" placeholder="admin@school.com" />
                    </div>

                    <div class="input-group">
                        <label for="adminphone">Phone ADMIN</label>
                        <input type="text" id="adminphone" name="adminphone" placeholder="+14024307272"  />
                    </div>
                ...
                <p class="auth-switch">
                    ...
                    <a class="link" href="login.jsp">Sign in</a>
                </p>
            </section>
        </main>
    </body>
